...
Feature: Tests the media civictheme image
  ...
  Scenario: Ensure that a Image renders correctly when added to WYSIWYG.
    ...
    And I should see the "div.civictheme-accordion__content .civictheme-figure img" element with the "src" attribute set to "/sites/default/files/civictheme_test/test_image.jpg"
