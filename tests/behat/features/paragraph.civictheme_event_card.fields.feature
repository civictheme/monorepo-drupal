...
Feature: Event Card fields
  ...
  Scenario: Fields appear as expected
    ...
    And I should see an "[name='field_c_n_components[0][subform][field_c_p_list_items][0][subform][field_c_p_topic][0][target_id]']" element
    And I should not see an "[name='field_c_n_components[0][subform][field_c_p_list_items][0][subform][field_c_p_topic][0][target_id]'].required" element
    And I should not see an "[name='field_c_n_components[0][subform][field_c_p_list_items][0][subform][field_c_p_topic][0][target_id]'][disabled]" element
