...
Feature: Tests the Promo paragraph
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I press the "field_n_components_civic_promo_add_more" button
    And I wait for AJAX to finish
    ...
    And should see an "input[name='field_n_components[0][subform][field_p_link][0][uri]']" element
    And should see an "input[name='field_n_components[0][subform][field_p_link][0][uri]'].required" element
