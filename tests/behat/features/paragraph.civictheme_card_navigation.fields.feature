@civictheme @paragraph @civictheme_card_navigation
Feature: Tests the Card container paragraph
  ...
  Scenario: Paragraph type appears in the paragraph types page
    ...
    Then I should see the text "Navigation card" in the "civictheme_card_navigation" row

  @api
  Scenario: Card container paragraph exists with fields.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_card_navigation/fields"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_c_n_components_0_subform_field_c_p_cards_civictheme_card_navigation_add_more" button
    And I wait for AJAX to finish
