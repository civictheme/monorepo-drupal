@civic @paragraph @civic_card_reference_promo
Feature: Tests the Reference promo card paragraph
  ...
  Scenario: Reference promo card paragraph field_c_p_reference fields settings.
    Given I am logged in as a user with the "Site Administrator" role
    When I go to "admin/structure/paragraphs_type/civic_card_reference_promo/fields/paragraph.civic_card_reference_promo.field_c_p_reference"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_c_n_components_0_subform_field_c_p_cards_civic_card_reference_promo_add_more" button
    And I wait for AJAX to finish
