@paragraph @civic_card_event_reference
Feature: Tests the Event reference card paragraph
  ...
  @api
  Scenario: Event reference card paragraph field_p_reference fields settings.
    Given I am logged in as a user with the "Site Administrator" role
    When I go to "admin/structure/paragraphs_type/civic_card_event_reference/fields/paragraph.civic_card_event_reference.field_p_reference"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_n_components_0_subform_field_p_cards_civic_card_event_reference_add_more" button
    And I wait for AJAX to finish
