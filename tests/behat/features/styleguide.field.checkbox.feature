...
Feature: Field, Checkbox
  ...
  Scenario: Checkbox
    ...
    And I should see an ".ct-field.js-form-item-test-checkbox-3 label.ct-visually-hidden" element
    ...
    And I should see an ".ct-field.js-form-item-test-checkbox-5 label.ct-field__title" element
