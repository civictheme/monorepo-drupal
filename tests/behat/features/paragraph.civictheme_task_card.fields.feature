@civictheme @paragraph @civictheme_task_card
Feature: Tests the Task card paragraph
  ...
  Scenario: Paragraph type appears in the paragraph types page
    ...
    Then I should see the text "Task card" in the "civictheme_task_card" row

  @api
  Scenario: Content paragraph exists with fields.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_task_card/fields"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I should not see an "input[name='field_c_n_components[0][subform][field_c_p_cards][0][subform][field_c_p_link][0][title]']" element
