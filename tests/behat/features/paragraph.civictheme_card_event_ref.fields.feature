@civictheme @paragraph @civictheme_card_event_ref
Feature: Tests the Event reference card paragraph
  ...
  Scenario: Paragraph type appears in the paragraph types page
    ...
    Then I should see the text "Event reference card" in the "civictheme_card_event_ref" row

  @api
  Scenario: Content paragraph exists with fields.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_card_event_ref/fields"
  ...
  Scenario: Event reference card paragraph field_c_p_reference fields settings.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_card_event_ref/fields/paragraph.civictheme_card_event_ref.field_c_p_reference"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_c_n_components_0_subform_field_c_p_cards_civictheme_card_event_ref_add_more" button
    And I wait for AJAX to finish
