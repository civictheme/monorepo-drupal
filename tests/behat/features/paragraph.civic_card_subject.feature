...
Feature: Tests the Subject card paragraph
  ...
  @api
  Scenario: Subject card paragraph field_p_cards fields settings.
    Given I am logged in as a user with the "Site Administrator" role
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_n_components_0_subform_field_p_cards_civic_card_subject_add_more" button
    And I wait for AJAX to finish
    ...
    And I should see an "input[name='field_p_image-media-library-open-button-field_n_components-0-subform-field_p_cards-0-subform']" element
