...
Feature: Check that custom settings is available in theme settings
  ...
  Scenario: The CivicTheme theme settings verify custom logo configuration with stream wrapper
    ...
    And I fill in "Header mobile logo path" with "public://civictheme_test/header_logo_mobile.jpg"
    ...
    And I should see the ".civictheme-header .civictheme-logo .civictheme-image" element with the "src" attribute set to "/sites/default/files/civictheme_test/header_logo_desktop.jpg"
    And I should see the ".civictheme-header .civictheme-logo img.civictheme-image" element with the "src" attribute set to "/sites/default/files/civictheme_test/header_logo_mobile.jpg"
  ...
  Scenario: The CivicTheme theme settings verify custom logo configuration with static assets
    ...
    And I fill in "Header mobile logo path" with "sites/default/files/civictheme_test/header_logo_mobile.jpg"
    And I fill in "Footer desktop logo path" with "sites/default/files/civictheme_test/footer_logo_desktop.jpg"
    And I fill in "Footer mobile logo path" with "sites/default/files/civictheme_test/footer_logo_mobile.jpg"
