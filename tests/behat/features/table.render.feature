...
Feature: Table render
  ...
  Scenario: Views page should show table with correct markup.
    Given civictheme_page content:
      ...
      | [TEST] Page 1 | 1      | [relative:1 min ago] |
      | [TEST] Page 2 | 1      | [relative:2 min ago] |
      | [TEST] Page 3 | 1      | [relative:3 min ago] |
      | [TEST] Page 4 | 1      | [relative:4 min ago] |
      | [TEST] Page 5 | 1      | [relative:5 min ago] |
      | [TEST] Page 6 | 1      | [relative:6 min ago] |
