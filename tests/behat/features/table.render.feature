...
Feature: Table render
  ...
  Scenario: Views page should show table with correct markup.
    Given civictheme_page content:
      | title         | status | created                  | moderation_state |
      | [TEST] Page 1 | 1      | [relative:1 second ago]  | published        |
      | [TEST] Page 2 | 1      | [relative:2 seconds ago] | published        |
      | [TEST] Page 3 | 1      | [relative:3 seconds ago] | published        |
      | [TEST] Page 4 | 1      | [relative:4 seconds ago] | published        |
      | [TEST] Page 5 | 1      | [relative:5 seconds ago] | published        |
      | [TEST] Page 6 | 1      | [relative:6 seconds ago] | published        |
