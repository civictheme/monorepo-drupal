...
Feature: Pagination
  ...
  Scenario: Views page with full pager and items per page should render and function correctly
    ...
    And I should see an ".ct-list__results-below .ct-pagination" element
    And I should not see "First" in the ".ct-list__results-below .ct-pagination" element
    And I should see "Prev" in the ".ct-list__results-below .ct-pagination .ct-pagination__link[disabled]" element
    And I should see "Last" in the ".ct-list__results-below .ct-pagination" element
    And I should not see a ".ct-pagination .ct-pagination__item--ellipsis-next" element
    And I should not see a ".ct-pagination .ct-pagination__item--ellipsis-previous" element
    And I click "2"
    And I should see "Last" in the ".ct-list__results-below .ct-pagination" element
    ...
    And I should see "Items per page" in the ".ct-list__results-below .ct-pagination .ct-pagination__items_per_page" element
    And I should not see a ".ct-pagination .ct-pagination__item--ellipsis-next" element
    And I should not see a ".ct-pagination .ct-pagination__item--ellipsis-previous" element
  ...
  Scenario: Views page with mini pager and items per page should render and function correctly
    ...
    And I should not see "First" in the ".ct-list__results-below .ct-pagination" element
    And I should see "Prev" in the ".ct-list__results-below .ct-pagination .ct-pagination__link[disabled]" element
    And I should see "1" in the ".ct-list__results-below .ct-pagination .ct-pagination__link.ct-link--active" element
    And I should not see "Last" in the ".ct-list__results-below .ct-pagination" element
    And I should see a ".ct-pagination .ct-pagination__item--ellipsis-next" element
    And I should not see a ".ct-pagination .ct-pagination__item--ellipsis-previous" element
    And I click "Next"
    And I should see a ".ct-pagination .ct-pagination__item--ellipsis-next" element
    And I should see a ".ct-pagination .ct-pagination__item--ellipsis-previous" element
    And I should not see "Last" in the ".ct-list__results-below .ct-pagination" element
    And I should not see "First" in the ".ct-list__results-below .ct-pagination" element
    And I should see "2" in the ".ct-list__results-below .ct-pagination .ct-pagination__link.ct-link--active" element
    And I click "Prev"
    And I should see "Prev" in the ".ct-list__results-below .ct-pagination .ct-pagination__link[disabled]" element
    And I should see "1" in the ".ct-list__results-below .ct-pagination .ct-pagination__link.ct-link--active" element
    And I should see "Items per page" in the ".ct-list__results-below .ct-pagination .ct-pagination__items_per_page" element
