...
Feature: Tests the Card container paragraph
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I should see an "select[name='field_c_n_components[0][subform][field_c_p_vertical_spacing]']" element
    And I should see an "input[name='field_c_n_components[0][subform][field_c_p_background][value]']" element
    And I should see an "input[name='field_c_n_components_0_subform_field_c_p_cards_civictheme_task_card_add_more']" element
