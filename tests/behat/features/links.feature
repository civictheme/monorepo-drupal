...
Feature: Check that content links have the correct classes.
  ...
  Scenario: Links in content have correct classes assigned.
    ...
    And "field_c_n_components" in "civictheme_page" "node" with "title" of "[TEST] Page 1" has "civictheme_content" paragraph:
      ...
      | field_c_p_content:format | civictheme_rich_text                                                          |
    And "field_c_n_components" in "civictheme_page" "node" with "title" of "[TEST] Page 1" has "civictheme_content" paragraph:
      | field_c_p_content:value  | <a href="http://example.com/external-ink">External link</a> |
      | field_c_p_content:format | civictheme_rich_text                                        |
    And "field_c_n_components" in "civictheme_page" "node" with "title" of "[TEST] Page 1" has "civictheme_content" paragraph:
      | field_c_p_content:value  | <a href="http://exampleoverridden.com/external-ink">External link from overridden domain</a> |
      | field_c_p_content:format | civictheme_rich_text                                                                         |

    And I am logged in as a user with the "Site Administrator" role
    And I visit "/admin/appearance/settings/civictheme_demo"
    And I fill in "Override domains" with "http://exampleoverridden.com"
    ...
    Then I should see an ".civictheme-basic-content a[href='http://example.com/internal-absolute-link'].civictheme-link" element
    And I should not see an ".civictheme-basic-content a[href='http://exampleoverridden.com/external-ink'].civictheme-link.civictheme-link--external" element
