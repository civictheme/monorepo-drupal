...
Feature: Search block render
  ...
  Background:
    Given "civictheme_search" block_content:
      | info     | field_c_b_link:title          | field_c_b_link:uri  | field_c_b_link_in_mobile_menu | status | region       | moderation_state |
      | Search 2 | [TEST] Search link            | http://example.com  | 1                             | 1      | header_top_1 | published        |
      | Search 3 | [TEST] Non-Mobile Search link | http://example2.com | 0                             | 1      | header_top_1 | published        |
  ...
  Scenario: XSS - Search
    Given "civictheme_search" block_content:
      | info     | field_c_b_link:title          | field_c_b_link:uri  | field_c_b_link_in_mobile_menu | status | region       | moderation_state |
      | Search 4 | <script id="test-search--field_c_b_link_title">alert('[TEST] Search field_c_b_link_title')</script> | http://example.com  | 1                             | 1      | header_top_1 | published        |
