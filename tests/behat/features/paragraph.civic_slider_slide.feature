...
Feature: Tests the Slider Slide paragraph
  ...
  Scenario: Slider Slide paragraph exists with fields.
    ...
    And I should see the text "field_p_image_position" in the "Image position" row
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I should see an "div.js-form-item-field-n-components-0-subform-field-p-slides-0-subform-field-p-title-0-value select.required" element
    ...
    And I should see an "#field_p_image-media-library-wrapper-field_n_components-0-subform-field_p_slides-0-subform" element
    ...
    And I should see an "div.js-form-item-field-n-components-3-subform-field-p-slides-0-subform-field-p-topic-0-target-id" element
