...
Feature: Campaign fields
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I click on ".field--name-field-c-n-components .add-more-button-civictheme-campaign.dropbutton-action" element
    ...
    And I should see an ".js-form-item-field-c-n-components-0-subform-field-c-p-image-position" element
    And I should see an ".js-form-item-field-c-n-components-0-subform-field-c-p-image-position select.required" element
