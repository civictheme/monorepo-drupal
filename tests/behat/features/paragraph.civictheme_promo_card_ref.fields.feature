...
Feature: Tests the Promo reference card paragraph
  ...
  Scenario: Paragraph type appears in the paragraph types page
    ...
    Then I should see the text "Promo reference card" in the "civictheme_promo_card_ref" row

  @api
  Scenario: Content paragraph exists with fields.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_promo_card_ref/fields"
    And I should see the text "field_c_p_reference" in the "Reference" row
    And I should see the text "field_c_p_theme" in the "Theme" row

  @api
  Scenario: Promo reference card paragraph field_c_p_reference fields settings.
    Given I am logged in as a user with the "Administrator" role
    When I go to "admin/structure/paragraphs_type/civictheme_promo_card_ref/fields/paragraph.civictheme_promo_card_ref.field_c_p_reference"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_c_n_components_0_subform_field_c_p_cards_civictheme_promo_card_ref_add_more" button
    And I wait for AJAX to finish
