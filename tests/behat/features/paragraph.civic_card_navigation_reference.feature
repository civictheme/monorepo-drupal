...
Feature: Tests the Navigation reference card paragraph
  ...
  Scenario: Paragraph type appears in the paragraph types page
    ...
    Then I should see the text "Navigation reference card" in the "civic_card_navigation_reference" row

  @api
  Scenario: Content paragraph exists with fields.
    Given I am logged in as a user with the "Site Administrator" role
    When I go to "admin/structure/paragraphs_type/civic_card_navigation_reference/fields"
    And I should see the text "field_p_reference" in the "Reference" row
    And I should see the text "field_p_theme" in the "Theme" row

  @api
  Scenario: Navigation reference card paragraph field_p_reference fields settings.
    Given I am logged in as a user with the "Site Administrator" role
    When I go to "admin/structure/paragraphs_type/civic_card_navigation_reference/fields/paragraph.civic_card_navigation_reference.field_p_reference"
  ...
  Scenario: Show relevant fields depending on the 'Content type' selected
    ...
    And I wait 1 second
    And I press the "field_n_components_0_subform_field_p_cards_civic_card_navigation_reference_add_more" button
    And I wait for AJAX to finish
