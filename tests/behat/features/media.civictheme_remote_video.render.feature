...
Feature: CivicTheme remote video
  ...
  Background:
    ...
    Given "civictheme_remote_video" media:
      | name                                              | field_c_m_oembed_video                      | field_c_m_transcript:value                | field_c_m_transcript:format | uuid                                 | moderation_state |
      | [TEST] CivicTheme Remote Video Without Transcript | https://www.youtube.com/watch?v=C0DPdy98e4c |                                           |                             | 5bca9d25-2f72-4c41-9e89-a5d48dc1cd21 | published        |
      | [TEST] CivicTheme Remote Video With Transcript    | https://www.youtube.com/watch?v=C0DPdy98e4c | [TEST] CivicTheme Remote Video Transcript | civictheme_rich_text        | 5bca9d25-2f72-4c41-9e89-a5d48dc1cd22 | published        |
