...
class CivicthemeUpdatePathFilledTest extends UpdatePathTestBase {
  ...
  public function testUpdates(): void {
    ...
    $this->assertSession()->pageTextContains('Update ran in');
    $this->assertSession()->pageTextContains('Processed: 34');
    $this->assertSession()->pageTextContains('Skipped: 34');
    ...
    $this->assertSession()->pageTextContains('Update ran in');
    $this->assertSession()->pageTextContains('Processed: 63');
    $this->assertSession()->pageTextContains('Skipped: 63');
    ...
    $this->assertSession()->pageTextContains('Updated: 93');
    ...
    $this->assertSession()->pageTextContains('Processed: 93');
    $this->assertSession()->pageTextContains('Updated: 93');
    $this->assertSession()->pageTextContains('Skipped: 0');
    ...
    $this->assertSession()->pageTextContains('Skipped: 93');
