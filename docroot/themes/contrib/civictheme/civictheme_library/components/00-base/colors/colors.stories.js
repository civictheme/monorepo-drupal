...
export const Colors = () => {
  ...
  const csv_path = { ...CSV_VARIABLES_PATH };
  ...
  let html = '';
  if (Object.values(csv_path['path'])) {
    html += `<div class="example-container__csv"><a href="${csv_path['path']}" target="_blank" download>Download color map CSV</a></div>`;
  }
