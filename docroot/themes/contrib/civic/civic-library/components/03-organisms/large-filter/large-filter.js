...
CivicLargeFilter.prototype.renderHTMLFilterItem = function (key, label, type, theme) {
  ...
  if (type !== 'input_radio') {
    ...
    <li class="civic-large-filter__tag">
      <button class="civic-button civic-theme-${theme} civic-button--chip civic-button--button civic-button--small civic-button--dismiss" data-component-name="filter-chip" data-id="${key}">
        ${label}
  ...
  return `
    <li class="civic-large-filter__tag">
      <button class="civic-button civic-theme-${theme} civic-button--chip civic-button--button civic-button--small" data-component-name="filter-chip" data-id="${key}">
        ${label}
      </button>
    </li>
  `;
