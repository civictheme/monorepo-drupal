function CivicMobileNavigation(el) {
  this.el = el;
  this.expandedClasses = {
    trigger: 'civic-header__menu-toggle--expanded',
    menu: 'civic-mobile-navigation--expanded',
  };
  ...
  this.mobileMenuCloseTrigger = document.querySelector('[data-component-name="civic-mobile-navigation-close-trigger"]');
...
CivicMobileNavigation.prototype.openEvent = function (e) {
  e.stopPropagation();
  e.preventDefault();
...
// eslint-disable-next-line func-names
CivicMobileNavigation.prototype.closeEvent = function (e) {
  e.stopPropagation();
  e.preventDefault();
  e.stopImmediatePropagation();
...
// eslint-disable-next-line func-names
CivicMobileNavigation.prototype.open = function () {
...
// eslint-disable-next-line func-names
CivicMobileNavigation.prototype.close = function () {
...
document.querySelectorAll('[data-component-name="civic-mobile-navigation-open-trigger"]').forEach((mobileMenu) => {
  // eslint-disable-next-line no-new
  new CivicMobileNavigation(mobileMenu);
});
